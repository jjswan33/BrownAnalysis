...
class METCalibrator  {
  ...
  reco::Candidate::LorentzVector calibrate(const reco::Candidate::LorentzVector& met,
	...
	if(calibrationScheme_=="Phil_W")
	  return calibratePhil(met,leg1,leg2,genParticles,jetsW);
    else if(calibrationScheme_.find("Phil") ==0)
  ...
  reco::Candidate::LorentzVector calibratePhil(const reco::Candidate::LorentzVector& metV,
    ...
    if(calibrationScheme_=="Phil_Z" &&njet==0)
      philCorrectorZ0->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_Z" &&njet==1)
      philCorrectorZ1->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_Z" &&njet>=2)
      philCorrectorZ2->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,2); 

    if(calibrationScheme_=="Phil_W" &&njet==0)
      philCorrectorW0->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_W" &&njet==1)
      philCorrectorW1->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_W" &&njet>=2)
      philCorrectorW2->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,2); 


    if(calibrationScheme_=="Phil_H" &&njet==0)
      philCorrectorH0->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_H" &&njet==1)
      philCorrectorH1->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,njet); 
    if(calibrationScheme_=="Phil_H" &&njet>=2)
      philCorrectorH2->CorrectType1(met,metphi,lGenPt,lGenPhi,lepPt,lepPhi,iU1,iU2,shiftScale_,shiftRes_,2); 
