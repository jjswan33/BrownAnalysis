...
typedef std::vector<PATMuMuJJQuad> PATMuMuJJQuadCollection;
...
typedef edm::Ref<PATMuMuJJQuadCollection> PATMuMuJJQuadRef;
...
typedef edm::RefProd<PATMuMuJJQuadCollection> PATMuMuJJQuadRefProd;

/// vector of references to CompositeRefCandidateT1T2MEt objects all in the same collection
typedef edm::RefVector<PATJetPairCollection> PATJetPairRefVector;
...
typedef edm::RefVector<PATMuMuJJQuadCollection> PATMuMuJJQuadRefVector;
