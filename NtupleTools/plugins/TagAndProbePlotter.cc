...
typedef TagAndProbePlotter<PATElecTauPair,pat::Tau> ElectronTauTagAndProbePlotter;
typedef TagAndProbePlotter<PATMuPair,pat::Muon> MuonPairTagAndProbePlotter;
...
DEFINE_FWK_MODULE(ElectronTauTagAndProbePlotter);
DEFINE_FWK_MODULE(MuonPairTagAndProbePlotter);
